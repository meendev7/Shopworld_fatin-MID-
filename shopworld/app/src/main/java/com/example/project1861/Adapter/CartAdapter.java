...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.binding.feeEachItem.setText("RM" + listItemSelected.get(position).getPrice());
        holder.binding.totalEachItem.setText("RM" + Math.round((listItemSelected.get(position).getNumberinCart() * listItemSelected.get(position).getPrice())));
